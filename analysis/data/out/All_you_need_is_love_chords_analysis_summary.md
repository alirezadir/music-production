...
- **Fast changes** (< 2 bars): 21 chords
- **Medium changes** (2-4 bars): 14 chords
- **Slow changes** (> 4 bars): 14 chords

### Long Chords (Section Markers)
- **D#:maj (IV) at bars 93-101 (duration: 8.0 bars)**
- **G:min (vi) at bars 118-125 (duration: 7.7 bars)**
- **D#:maj (IV) at bars 125-133 (duration: 8.0 bars)**
- **G:min (vi) at bars 134-142 (duration: 8.5 bars)**
...
### Key Insights
1. **Most Common Chord**: G:min (vi) - 17 times
2. **Most Common Progression**: IV → vi - 14 times
3. **Harmonic Rhythm**: Moderate (3.0 bars average)
4. **Total Cadences**: 2
